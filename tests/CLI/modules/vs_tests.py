...
class VirtTests(testing.TestCase):
    ...
    def test_create_options(self):
        ...
        self.assertEqual(json.loads(result.output),
                         {'cpus (dedicated host)': [4, 56],
                          ...
                          'flavors (balanced - transient)': ['B1_1X2X25'],
    ...
    def test_create_flavor_with_cpu(self):
        result = self.run_command(['vs', 'create',
                                   '--flavor=B1_1X2X25',
                                   '--cpu=2',
                                   '--domain=example.com',
    ...
    def test_create_flavor_with_memory(self):
        result = self.run_command(['vs', 'create',
                                   '--flavor=B1_1X2X25',
                                   '--memory=1',
                                   '--domain=example.com',
    ...
    def test_create_flavor_with_dedicated(self):
        result = self.run_command(['vs', 'create',
                                   '--flavor=B1_1X2X25',
                                   '--domain=example.com',
                                   '--hostname=host',
    ...
    def test_create_flavor_with_host_id(self):
        result = self.run_command(['vs', 'create',
                                   '--flavor=B1_1X2X25',
                                   '--domain=example.com',
                                   '--hostname=host',
